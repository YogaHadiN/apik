<template>
    <div class="flex min-h-screen">
      <div class="w-64 overflow-y-scroll bg-indigo-800">
        <div class="px-6 pt-8">
        ...
        <div class="px-6 pt-4">
          <div class="relative">
            <div
              ...
              <svg
                class="w-4 h-4 text-gray-300 stroke-current"
                fill="none"
                viewBox="0 0 24 24"
                >
                <path
            ...
            <input
              type="text"
              class="w-full rounded pl-8 pr-4 py-2.5 text-sm font-light bg-gray-800 text-gray-400 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800"
              placeholder="search"
              />
          </div>
        </div>
        ...
        <div class="px-6 pt-4">
          <ul class="flex flex-col space-y-2">
            <li class="relative text-gray-300 hover:text-white focus-within:text-white">
              <div
                class="absolute inset-y-0 left-0 flex items-center pl-2 pointer-events-none"
                >
              ...
              <Link
                href="/dashboard"
                class="inline-block w-full py-2 pl-8 pr-4 text-sm rounded hover:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800"
                > Dashboard</Link
              >
            ...
            <li 
              ...
              <div
                ...
                <div class="flex items-center w-full">
                  ...
                  <button
                    class="inline-block w-full py-2 pl-8 pr-4 text-sm text-left rounded hover:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800"
                    >Data-data</button
                 >
                </div>
              ...
              <div class="pt-2 pl-4" v-if="open_menu == 'data-data'">
                <ul class="flex flex-col pl-2 text-gray-300 border-l border-gray-700">
                  <li>
                    <Link
                      href="/users"
                      class="inline-block w-full px-4 py-2 text-sm rounded hover:bg-gray-800 hover:text-white focus:outline-none focus:ring-1 focus:ring-gray-500 focus:text-white"
                      >User</Link
                    >
                  </li>
                  <li>
		...
		<div class="relative">
		  <jet-dropdown align="right" width="48">
			<template #trigger>
			  <div class="pl-6 pr-4 py-4 bg-[#232529] flex items-center justify-between full-width">
				<div class="flex items-center">
				  ...
				  <div class="flex flex-col pl-3">
					...
					<span class="text-sm text-[#acacb0] font-light tracking-tight">
...
<script>
    ...
    import PrimaryNavigation from '@/Jetstream/PrimaryNavigation.vue'
    import JetDropdown from '@/Jetstream/Dropdown.vue'
	import SideMenu from '@/Jetstream/SideMenu.vue'
    ...
    export default defineComponent({
        ...
        components: {
            ...
            Link,
            CalendarIcon, ChatIcon, ClipboardListIcon, ClockIcon, HeartIcon, HomeIcon, SearchIcon
        },
        data() {
            return {
                mainNavigation: [
