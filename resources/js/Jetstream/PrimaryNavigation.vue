<template>
                            ...
                            <div class="flex justify-between h-16">
                                <div class="flex">
                                    ...
                                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                        ...
                                        <jet-nav-link :href="route('mereks.index')" :active="route().current('mereks*')">
                                          Obat
                                        </jet-nav-link>
                                        <jet-nav-link :href="route('asuransis.index')" :active="route().current('asuransis*')">
                                          Asuransi
                                        </jet-nav-link>
                                        <jet-nav-link :href="route('tarifs.index')" :active="route().current('tarifs*')">
                                            Tarif
                                        </jet-nav-link>
                                    </div>
                                </div>
                        ...
                        <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                            <div class="pt-2 pb-3 space-y-1">
                                ...
                                <jet-responsive-nav-link :href="route('mereks.index')" :active="route().current('mereks*')">
                                  Obat
                                </jet-responsive-nav-link>
                                <jet-responsive-nav-link :href="route('asuransis.index')" :active="route().current('asuransis*')">
                                  Asuransi
                                </jet-responsive-nav-link>
                                <jet-responsive-nav-link :href="route('tarifs.index')" :active="route().current('tarifs*')">
                                    Tarif
                                </jet-responsive-nav-link>
                            </div>
