...
export default {
  components: {Link, Head,ChatIcon, HeartIcon, HomeIcon, Menu, MenuButton, MenuItems, MenuItem, SearchIcon, AuthenticationCardLogo},
  data() {
    return {
      mainNavigation: [
  ...
  methods: {
    open(menu){
      console.log('open_menu = ' + this.open_menu);
