    ...
    <div class="inline-flex justify-center items-center">
      ...
      <div class="flex space-x-1 items-top" v-if="pagination.last_page > 1">
        ...
        <div class="flex flex-col space-y-2 md:flex-row md:space-y-0 md:items-center md:space-x-1">
          <input type="text" @keydown.enter="loadPage(page)" @keypress="this.isNumber($event)" v-model="page" class="px-2 w-11 h-11 text-center rounded border border-gray-400 shadow-sm lg:h-9 lg:w-9 lg:text-sm focus:ring-blue-500 focus:border-blue-500"/>
